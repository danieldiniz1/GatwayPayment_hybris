 ...
 */
package br.com.vivo.test.setup;
...
import br.com.vivo.test.constants.VivoTestConstants;
import br.com.vivo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = VivoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/vivotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/vivotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/vivotest/import/cstickets.impex");
			...
			importImpexFile(context, "/vivotest/import/csquotes.impex");
		}
	}
}
