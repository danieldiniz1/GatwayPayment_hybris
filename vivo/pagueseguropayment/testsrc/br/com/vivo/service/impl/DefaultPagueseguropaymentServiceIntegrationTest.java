...
import br.com.vivo.service.impl.DefaultPagueseguropaymentService;
 ...
 */
@IntegrationTest
public class DefaultPagueseguropaymentServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "pagueseguropaymentPlatformLogo";

		// when
		final String logoUrl = pagueseguropaymentService.getHybrisLogoUrl(logoCode);
