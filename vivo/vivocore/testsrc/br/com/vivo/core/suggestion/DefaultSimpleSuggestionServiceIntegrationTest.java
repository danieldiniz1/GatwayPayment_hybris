 ...
 */
package br.com.vivo.core.suggestion;
...
import br.com.vivo.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/vivocore/test/testSimpleSuggestionService.csv", "utf-8");
	}
