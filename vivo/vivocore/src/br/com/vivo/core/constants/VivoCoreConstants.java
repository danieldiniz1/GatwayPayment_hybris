...
/**
 * Global class for all VivoCore constants. You can add global constants for your extension into this class.
 */
public final class VivoCoreConstants extends GeneratedVivoCoreConstants
{
	public static final String EXTENSIONNAME = "vivocore";


	private VivoCoreConstants()
	{
		//empty
	}
