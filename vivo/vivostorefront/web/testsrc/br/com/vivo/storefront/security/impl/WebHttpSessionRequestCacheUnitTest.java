...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vivostorefront/electronics/en",
						"https://electronics.local:9002/vivostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vivostorefront/electronics/en",
						"https://electronics.local:9002/vivostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vivostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/vivostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vivostorefront/electronics/en",
						"https://electronics.local:9002/vivostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vivostorefront",
						"https://electronics.local:9002/vivostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vivostorefront",
						"https://electronics.local:9002/vivostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/vivostorefront/electronics/en",
						"https://electronics.local:9002/vivostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
