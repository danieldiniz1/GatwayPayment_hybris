 ...
 */
package br.com.vivo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(VivoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(VivoFulfilmentProcessConstants.PARENT_PROCESS);
