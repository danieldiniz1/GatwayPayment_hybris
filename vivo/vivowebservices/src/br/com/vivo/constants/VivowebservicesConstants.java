...
/**
 * Global class for all Vivowebservices constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings({"deprecation","squid:CallToDeprecatedMethod"})
public final class VivowebservicesConstants extends GeneratedVivowebservicesConstants
{
	public static final String EXTENSIONNAME = "vivowebservices";
	...
	public static final String HOST = "vivowebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private VivowebservicesConstants()
	{
