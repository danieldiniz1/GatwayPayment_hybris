...
import br.com.vivo.data.UserDataList;
import br.com.vivo.dto.SampleWsDTO;
import br.com.vivo.dto.TestMapWsDTO;
import br.com.vivo.dto.UserWsDTO;
import br.com.vivo.dto.UsersListWsDTO;
import br.com.vivo.dto.UsersPageWsDTO;
import br.com.vivo.facades.SampleFacades;

import static br.com.vivo.constants.VivowebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static br.com.vivo.constants.VivowebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
import static br.com.vivo.constants.VivowebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static br.com.vivo.constants.VivowebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/vivowebservices/sample/dto/sampleValue
	 *
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/vivowebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/vivowebservices/sample/users
	 * <li>http://localhost:9001/vivowebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/vivowebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/vivowebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/vivowebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/vivowebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/vivowebservices/sample/usersPaged
	 * <li>http://localhost:9001/vivowebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/vivowebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/vivowebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 * <p>
	 * Url: http://localhost:9001/vivowebservices/sample/map
	 */
